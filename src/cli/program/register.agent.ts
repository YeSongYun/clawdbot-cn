...
${theme.muted(t("cli", "help.docs", "Docs:"))} ${formatDocsLink("/cli/agent", "docs.clawd.bot/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted(t("cli", "help.docs", "Docs:"))} ${formatDocsLink("/cli/agents", "docs.clawd.bot/cli/agents")}\n`,
    );
